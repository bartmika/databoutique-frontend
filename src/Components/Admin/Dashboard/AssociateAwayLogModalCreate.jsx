...
import { faPlus, faEye, faCircleCheck, faClose, faCheck, faCircleExclamation, faArrowRight } from '@fortawesome/free-solid-svg-icons';import { useRecoilState } from 'recoil';
...
function AssociateAwayLogCreateModal({ currentUser, showCreateModal, setShowCreateModal, onSuccessCreateCallbackFunc }) {
    ////
    //// Global state.
    ////
        ...
        <div class={`modal ${showCreateModal ? 'is-active' : ''}`}>
            ...
            <div class="modal-card">
                <header class="modal-card-head">
                    <p class="modal-card-title"><FontAwesomeIcon className="mdi" icon={faPlus} />&nbsp;New Associate News</p>
                ...
                {isFetching ?
                    ...
                    <footer class="modal-card-foot">
                        ...
                        <button class="button is-success" onClick={onSaveClick}>
                            <FontAwesomeIcon className="mdi" icon={faCheck} />&nbsp;Submit
                        </button>
                    </footer>
                }
            </div>
