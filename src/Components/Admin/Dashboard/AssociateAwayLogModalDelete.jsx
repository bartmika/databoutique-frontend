...
import { faTrash, faCircleCheck, faClose, faCheck, faCircleExclamation, faArrowRight } from '@fortawesome/free-solid-svg-icons';import { useRecoilState } from 'recoil';
...
function AssociateAwayLogDeleteModal({ currentUser, showDeleteModalForAssociateAwayLogID, setShowDeleteModalForAssociateAwayLogID, onSuccessDeleteCallbackFunc }) {
    ////
    //// Global state.
    ////
    ...
    return (
        <div class={`modal ${showDeleteModalForAssociateAwayLogID ? 'is-active' : ''}`}>
            <div class="modal-background"></div>
            <div class="modal-card">
                <header class="modal-card-head">
                    <p class="modal-card-title"><FontAwesomeIcon className="mdi" icon={faTrash} />&nbsp;Delete</p>
                    ...
                    <>
                        <section class="modal-card-body">
                            <div class="content">
                                ...
                                You are about to delete this associate news. This action cannot be undone. Are you sure you want to continue?
                            </div>
                        </section>
                        <footer class="modal-card-foot">
                            ...
                            <button class="button is-success" onClick={onDeleteClick}>
                                <FontAwesomeIcon className="mdi" icon={faCheck} />&nbsp;Confirm and Delete
                            </button>
                        </footer>
                    </>
                }
