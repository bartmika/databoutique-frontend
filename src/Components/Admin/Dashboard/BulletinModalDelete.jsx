...
function BulletinDeleteModal({ currentUser, showDeleteModalForBulletinID, setShowDeleteModalForBulletinID, onSuccessDeleteCallbackFunc }) {
    ////
    //// Global state.
    ////
                    ...
                    <>
                        <section class="modal-card-body">
                            <div class="content">
                                ...
                                You are about to delete this bulletin. This action cannot be undone. Are you sure you want to continue?
                            </div>
                        </section>
