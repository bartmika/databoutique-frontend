...
function BulletinCreateModal({ currentUser, showCreateModal, setShowCreateModal, onSuccessCreateCallbackFunc }) {
    ////
    //// Global state.
    ////
        ...
        <div class={`modal ${showCreateModal ? 'is-active' : ''}`}>
            ...
            <div class="modal-card">
                <header class="modal-card-head">
                    <p class="modal-card-title"><FontAwesomeIcon className="mdi" icon={faPlus} />&nbsp;New Bulletin</p>
