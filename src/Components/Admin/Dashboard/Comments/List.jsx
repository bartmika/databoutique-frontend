...
function AdminCommentList() {
    ...
    function onCommentDeleteError(apiErr) {
        ...
        setTimeout(() => {
            console.log("onCommentDeleteError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
                ...
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-touch" aria-label="breadcrumbs">
                        <ul className="">
                            ...
                            <li className="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faUserCircle} />&nbsp;Comments</Link></li>
                        </ul>
                    </nav>
                    ...
                    {/* Page Title */}
                    <h1 className="title is-2"><FontAwesomeIcon className="fas" icon={faUserCircle} />&nbsp;Comments</h1>
                    <hr />
                                ...
                                {users && users.results && (users.results.length > 0 || previousCursors.length > 0)
                                    ...
                                    <section className="hero is-medium has-background-white-ter">
                                        <div className="hero-body">
                                            <p className="title">
                                                <FontAwesomeIcon className="fas" icon={faTable} />&nbsp;No Comments
                                            </p>
                                            <p className="subtitle">
                                                No comments. <b><Link to="/admin/comments/add/step-1">Click here&nbsp;<FontAwesomeIcon className="mdi" icon={faArrowRight} /></Link></b> to get started creating your first comment.
                                            </p>
                                        </div>
                                    </section>
                                }
