...
import AdminProgramCategoryListDesktop from "./Desktop";
import AdminProgramCategoryListMobile from "./Mobile";


function AdminProgramCategoryList() {
                ...
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-touch" aria-label="breadcrumbs">
                        <ul className="">
                            ...
                            <li className="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faRobot} />&nbsp;Program Categories</Link></li>
                        </ul>
                    </nav>
                                ...
                                <div className="columns is-vcentered">
                                    <div className="column">
                                        <BubbleLink
                                            ...
                                            faIcon={faPlus}
                                            url={`/admin/program-categories/add`}
                                    ...
                                    <div className="column">
                                        <BubbleLink
                                            ...
                                            faIcon={faSearch}
                                            url={`/admin/program-categories/search`}
                                ...
                                {listData && listData.results && (listData.results.length > 0 || previousCursors.length > 0)
                                    ...
                                    <div className="container">
                                        ...
                                        */}
                                        <div className="is-hidden-touch" >
                                            <AdminProgramCategoryListDesktop
                                                listData={listData}
                                                listCount={listCount}
                                        ...
                                        */}
                                        <div className="is-fullwidth is-hidden-desktop">
                                            <AdminProgramCategoryListMobile
                                                listData={listData}
                                                listCount={listCount}
                                                setPageSize={setPageSize}
                                                pageSize={pageSize}
                                    ...
                                    <section className="hero is-medium has-background-white-ter">
                                        <div className="hero-body">
                                            <p className="title">
                                                <FontAwesomeIcon className="fas" icon={faTable} />&nbsp;No ProgramCategorys
                                            </p>
                                            <p className="subtitle">
                                                No assistant. <b><Link to="/admin/program-categories/add">Click here&nbsp;<FontAwesomeIcon className="mdi" icon={faArrowRight} /></Link></b> to get started creating your first assistant.
                                            </p>
                                        </div>
                                    </section>
                                }
...
export default AdminProgramCategoryList;
