...
function AdminUserThreadListMobile(props) {
    const { listData, setPageSize, pageSize, previousCursors, onPreviousClicked, onNextClicked, onSelectUserForDeletion, id } = props;
        ...
        <>
            {listData && listData.results && listData.results.map(function(datum, i){
                ...
                return <div className="mb-5">
                    <hr />
                    <strong>Program:</strong>&nbsp;{datum.programName}
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    <Link to={`/admin/program/${id}/thread/${datum.id}`} className="button is-primary is-fullwidth-mobile" type="button">
