...
function AdminProgramSearch() {
    ...
    const onSubmitClick = (e) => {
        ...
        setForceURL("/admin/programs/search-result?name="+name+"&description="+description);
    }
                ...
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li className=""><Link to="/admin/programs" aria-current="page"><FontAwesomeIcon className="fas" icon={faRobot} />&nbsp;Program</Link></li>
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li className=""><Link to="/admin/clients" aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Programs</Link></li>
                        </ul>
                    </nav>
                                ...
                                <div className="container">
                                    ...
                                    <div className="columns pt-5">
                                        <div className="column is-half">
                                            <Link className="button is-medium is-fullwidth-mobile" to="/admin/programs"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Programs</Link>
                                        </div>
