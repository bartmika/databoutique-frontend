                                ...
                                {assistant && <div className="container">
                                    ...
                                    <div className= "tabs is-medium is-size-7-mobile">
                                        <ul>
                                            ...
                                            <li>
                                                <Link to={`/admin/assistant/${id}/threads`}>Threads</Link>
                                            </li>
                                    ...
                                    <div className="columns pt-5">
                                        <div className="column is-half">
                                            <Link to={`/admin/assistants`} className="button is-fullwidth-mobile">
                                                <FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Assistants
                                            </Link>
                                        </div>
...
export default AdminAssistantDetail;
