...
function AdminUserThreadListDesktop(props) {
    const { listData, setPageSize, pageSize, previousCursors, onPreviousClicked, onNextClicked, onSelectUserForDeletion, sortByValue, id } = props;
    return (
                            ...
                            return <tr>
                                ...
                                <td className="is-actions-cell">
                                    <div className="buttons is-right">
                                        <Link to={`/admin/assistant/${id}/thread/${datum.id}`} className="is-small">
