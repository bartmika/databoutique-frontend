...
function AdminAssistantThreadList() {
    ////
    //// URL Parameters.
    ////
                            ...
                            <>
                                ...
                                {user && <div className="container">
                                    ...
                                    <div className= "tabs is-medium is-size-7-mobile">
                                        <ul>
                                            <li>
                                                <Link to={`/admin/assistant/${id}`}>Detail</Link>
                                            </li>
                                        ...
                                        <section className="hero is-medium has-background-white-ter">
                                            <div className="hero-body">
                                                ...
                                                <p className="subtitle">
                                                    No threads found for this assistant.
                                                </p>
                                            </div>
                                        </section>
                                    }
...
export default AdminAssistantThreadList;
