...
function AdminUserDetailThreadDetail() {
    ...
    function onAssistantThreadDeleteSuccess(response){
        ...
        setForceURL("/admin/assistant/"+aid+"/threads");
    }
                ...
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li className=""><Link to={`/admin/assistant/${aid}/threads`} aria-current="page"><FontAwesomeIcon className="fas" icon={faEye} />&nbsp;Detail (Threads)</Link></li>
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li className=""><Link to={`/admin/assistant/${aid}/threads`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Detail (Threads)</Link></li>
                        </ul>
                    </nav>
                    ...
                    {/* Page Back Button */}
                    <Link to={`/admin/assistant/${aid}/threads`} className="is-fullwidth-mobile">
                                ...
                                {assistant && <div className="container ">
                                    ...
                                    <div className="columns pt-5">
                                        <div className="column is-half">
                                            <Link to={`/admin/assistant/${aid}/threads`} className="button is-fullwidth-mobile">
