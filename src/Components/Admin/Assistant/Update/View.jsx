...
function AdminAssistantUpdate() {
    ...
    const onSubmitClick = (e) => {
        ...
        putAssistantUpdateAPI(
            decamelizedData,
            onAdminAssistantUpdateSuccess,
            onAdminAssistantUpdateError,
            onAdminAssistantUpdateDone,
            onUnauthorized
        );
    ...
    function onAdminAssistantUpdateSuccess(response){
        // For debugging purposes only.
        console.log("onAdminAssistantUpdateSuccess: Starting...");
        ...
        setTimeout(() => {
            console.log("onAdminAssistantUpdateSuccess: Delayed for 2 seconds.");
            console.log("onAdminAssistantUpdateSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onAdminAssistantUpdateError(apiErr) {
        console.log("onAdminAssistantUpdateError: Starting...");
        setErrors(apiErr);
        ...
        setTimeout(() => {
            console.log("onAdminAssistantUpdateError: Delayed for 2 seconds.");
            console.log("onAdminAssistantUpdateError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onAdminAssistantUpdateDone() {
        console.log("onAdminAssistantUpdateDone: Starting...");
        setFetching(false);
    }
...
export default AdminAssistantUpdate;
