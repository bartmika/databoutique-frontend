            ...
            <div className="container">
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li className=""><Link to="/admin/clients" aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Assistants</Link></li>
                        </ul>
                    </nav>

                    {/* Page Title */}
                    <h1 className="title is-2"><FontAwesomeIcon className="fas" icon={faRobot} />&nbsp;Assistants</h1>
                                ...
                                <div className="container">
                                    ...
                                    <div className="columns pt-5">
                                        <div className="column is-half">
                                            <Link className="button is-medium is-fullwidth-mobile" to="/admin/assistants"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Assistants</Link>
                                        </div>
...
export default AdminAssistantSearch;
