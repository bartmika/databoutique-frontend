...
import AdminAssistantListDesktop from "./Desktop";
import AdminAssistantListMobile from "./Mobile";
                ...
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-touch" aria-label="breadcrumbs">
                        <ul className="">
                            ...
                            <li className="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faRobot} />&nbsp;Assistants</Link></li>
                        </ul>
                    </nav>
