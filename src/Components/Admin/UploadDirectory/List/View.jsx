...
import AdminUploadDirectoryListDesktop from "./Desktop";
import AdminUploadDirectoryListMobile from "./Mobile";


function AdminUploadDirectoryList() {
                ...
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-touch" aria-label="breadcrumbs">
                        <ul className="">
                            ...
                            <li className="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faCloudUpload} />&nbsp;My Uploads</Link></li>
                        </ul>
                    </nav>
                                ...
                                <div className="columns is-vcentered">
                                    <div className="column">
                                        <BubbleLink
                                            ...
                                            faIcon={faPlus}
                                            url={`/admin/upload-directories/add`}
                                    ...
                                    <div className="column">
                                        <BubbleLink
                                            ...
                                            faIcon={faSearch}
                                            url={`/admin/upload-directoriess/search`}
                                    ...
                                    <div className="container">
                                        ...
                                        */}
                                        <div className="is-hidden-touch" >
                                            <AdminUploadDirectoryListDesktop
                                                listData={listData}
                                                listCount={listCount}
                                        ...
                                        */}
                                        <div className="is-fullwidth is-hidden-desktop">
                                            <AdminUploadDirectoryListMobile
                                                listData={listData}
                                                listCount={listCount}
                                                setPageSize={setPageSize}
                                                pageSize={pageSize}
                                    ...
                                    <section className="hero is-medium has-background-white-ter">
                                        <div className="hero-body">
                                            ...
                                            <p className="subtitle">
                                                No folders. <b><Link to="/admin/upload-directories/add">Click here&nbsp;<FontAwesomeIcon className="mdi" icon={faArrowRight} /></Link></b> to get started creating your folder to upload your files to.
                                            </p>
                                        </div>
                                    </section>
                                }
...
export default AdminUploadDirectoryList;
