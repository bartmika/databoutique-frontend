...
function AdminUploadDirectoryUploadFileListDesktop(props) {
    const { listData, listCount, setPageSize, pageSize, previousCursors, onPreviousClicked, onNextClicked, onSelectClientForDeletion, sortByValue, udid } = props;
    return (
                            ...
                            return <tr>
                                ...
                                <td className="is-actions-cell">
                                    <div className="buttons is-right">
                                        <Link to={`/admin/upload-directory/${udid}/upload-file/${datum.id}`} className="is-small">
...
export default AdminUploadDirectoryUploadFileListDesktop;
