...
*/
function AdminUploadDirectoryUploadFileListMobile(props) {
        ...
        <>
            {listData && listData.results && listData.results.map(function(datum, i){
                return <div className="mb-5">
                    ...
                    <br />
                    <br />
                    <Link to={`/admin/upload-directory/${udid}/upload-file/${datum.id}`} className="button is-primary is-fullwidth-mobile" type="button">
...
export default AdminUploadDirectoryUploadFileListMobile;
