...
import { addAdminState, ADD_CUSTOMER_STATE_DEFAULT } from "../../../../../../AppState";


function AdminUploadFileSearch() {
    ////
    //// Global state.
    ////

    const [addAdmin, setAddAdmin] = useRecoilState(addAdminState);
    ...
    const onSubmitClick = (e) => {
        ...
        setForceURL("/admin/assistant-files/search-result?name="+name+"&description="+description);
    }
            ...
            <div className="container">
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li className=""><Link to="/admin/clients" aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Assistant Files</Link></li>
                        </ul>
                    </nav>
                                ...
                                <div className="container">
                                    ...
                                    <div className="columns pt-5">
                                        <div className="column is-half">
                                            <Link className="button is-medium is-fullwidth-mobile" to="/admin/assistant-files"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Assistant Files</Link>
                                        </div>
...
export default AdminUploadFileSearch;
