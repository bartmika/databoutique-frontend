...
function AdminUserListMobile(props) {
    const { listData, listCount, setPageSize, pageSize, previousCursors, onPreviousClicked, onNextClicked, onSelectUserForDeletion } = props;
    return (
        <>
            {listData && listData.results && listData.results.map(function(datum, i){
                return <div className="mb-5">
                    ...
                    <br />
                    <br />
                    <Link to={`/admin/user/${datum.id}`} className="button is-primary is-fullwidth-mobile" type="button">
