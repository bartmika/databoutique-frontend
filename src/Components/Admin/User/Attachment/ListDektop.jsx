...
function AdminUserDetailAttachmentListDesktop(props) {
                            ...
                            return <tr>
                                ...
                                <td className="is-actions-cell">
                                    <div className="buttons is-right">
                                        ...
                                        <button onClick={(e, ses) => onSelectAttachmentForDeletion(e, attachment)} className="button is-small is-danger" type="button">
...
export default AdminUserDetailAttachmentListDesktop;
