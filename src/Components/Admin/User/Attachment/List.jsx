...
import AdminUserDetailAttachmentListDesktop from "./ListDektop";
import AdminUserDetailAttachmentListMobile from "./ListMobile";


function AdminUserDetailAttachmentList() {
    ////
    //// URL Parameters.
    ////
        ...
        <>
            <div className="container">
                <section className="section">
                    ...
                    {/* Modal */}
                    <div className={`modal ${selectedAttachmentForDeletion ? 'is-active' : ''}`}>
                        <div className="modal-background"></div>
                        <div className="modal-card">
                            <header className="modal-card-head">
                                <p className="modal-card-title">Are you sure?</p>
                                <button className="delete" aria-label="close" onClick={onDeselectAttachmentForDeletion}></button>
                            </header>
                            ...
                            <footer className="modal-card-foot">
                                ...
                                <button className="button" onClick={onDeselectAttachmentForDeletion}>Cancel</button>
                            </footer>
                        </div>
                    </div>
                    ...
                    <nav className="box">
                        ...
                        <div className="columns">
                            <div className="column">
                                <p className="title is-4"><FontAwesomeIcon className="fas" icon={faFile} />&nbsp;Attachments</p>
                            </div>
                                    ...
                                    <div className= "tabs is-medium is-size-7-mobile">
                                        <ul>
                                            ...
                                            <li className="is-active">
                                                <Link to={`/admin/user/${cid}/attachments`}><strong>Attachments</strong></Link>
                                            </li>
                                            <li>
                                        ...
                                        <div className="container">
                                            ...
                                            */}
                                            <div className="is-hidden-touch" >
                                                <AdminUserDetailAttachmentListDesktop
                                                    userID={cid}
                                            ...
                                            */}
                                            <div className="is-fullwidth is-hidden-desktop">
                                                <AdminUserDetailAttachmentListMobile
                                                    userID={cid}
                                                    listData={attachments}
                                                    setPageSize={setPageSize}
                                                    pageSize={pageSize}
...
export default AdminUserDetailAttachmentList;
