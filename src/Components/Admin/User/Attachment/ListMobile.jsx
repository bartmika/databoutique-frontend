...
*/
function AdminUserDetailAttachmentListMobile(props) {
                ...
                return <div className="mb-5">
                    ...
                    <div className="is-hidden-mobile pt-2">
                        <div className="buttons is-right">
                            ...
                            <button onClick={(e, ses) => onSelectAttachmentForDeletion(e, datum)} className="button is-small is-danger" type="button">
                    ...
                    <div className="is-hidden-tablet pt-2">
                        <div className="columns is-mobile">
                            ...
                            <div className="column">
                                <button onClick={(e, ses) => onSelectAttachmentForDeletion(e, datum)} className="button is-small is-danger is-fullwidth" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faTrashCan} />&nbsp;Delete
                                </button>
                            </div>
                        </div>
...
export default AdminUserDetailAttachmentListMobile;
