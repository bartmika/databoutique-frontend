...
function AdminUserListDesktop(props) {
    const { listData, listCount, setPageSize, pageSize, previousCursors, onPreviousClicked, onNextClicked, onSelectUserForDeletion, sortByValue } = props;
    return (
                ...
                <table className="table is-fullwidth is-striped is-hoverable is-fullwidth">
                    <thead>
                        <tr>
                            ...
                            <th>
                                Last Name
                                {sortByValue === "lexical_name,ASC" && <>&nbsp;<FontAwesomeIcon className="fas" icon={faCaretUp} /></>}
                                {sortByValue === "lexical_name,DESC" && <>&nbsp;<FontAwesomeIcon className="fas" icon={faCaretDown} /></>}
                            </th>
                            <th>Phone</th>
                            <th>Email</th>
                            <th>Organization</th>
                            ...
                            return <tr>
                                ...
                                <td className="is-actions-cell">
                                    <div className="buttons is-right">
                                        <Link to={`/admin/user/${datum.id}`} className="is-small">
