...
import { getUserDetailAPI, postUpgradeUserAPI } from "../../../../API/User";
...
import { USER_ORGANIZATION_TYPE_OPTIONS_WITH_EMPTY_OPTIONS } from "../../../../Constants/FieldOptions";


function AdminUserUpgradeOperation() {
    ////
    //// URL Parameters.
    ////
    ...
    function onUpgradeSuccess(response){
        ...
        setTopAlertMessage("User upgraded");
                ...
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li className="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faBuildingUser} />&nbsp;Upgrade</Link></li>
                        </ul>
                    </nav>
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li className=""><Link to={`/admin/user/${cid}/more`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Detail</Link></li>
                        </ul>
                    </nav>
                    ...
                    <nav className="box">
                        ...
                        {user && <div className="columns">
                            <div className="column">
                                <p className="title is-4"><FontAwesomeIcon className="fas" icon={faBuildingUser} />&nbsp;Upgrade User</p>
                            </div>
                                ...
                                {user && <div className="container">
                                    <article className="message is-warning">
                                        <div className="message-body">
                                            <p className="title is-4"><FontAwesomeIcon className="fas" icon={faCircleExclamation} />&nbsp;Warning</p>
                                            <p>You are about to <b>upgrade</b> this user from <i>Residential</i> type into <i>Business</i>. This will affect the rates, associates and terms the user will now be applied. Are you sure you want to continue?</p>
                                        </div>
                                    </article>
                                    ...
                                    <div className="columns pt-5">
                                        <div className="column is-half">
                                            <Link className="button is-fullwidth-mobile" to={`/admin/user/${cid}/more`}><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Detail</Link>
                                        </div>
                                        <div className="column is-half has-text-right">
                                            <button className="button is-danger is-fullwidth-mobile" onClick={onSubmitClick}><FontAwesomeIcon className="fas" icon={faCheckCircle} type="button" />&nbsp;Confirm and Upgrade</button>
                                        </div>
                                    </div>
...
export default AdminUserUpgradeOperation;
