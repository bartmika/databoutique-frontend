                    ...
                    <nav className="box">
                        ...
                        {user && <div className="columns">
                            <div className="column">
                                <p className="title is-4"><FontAwesomeIcon className="fas" icon={faTrashCan} />&nbsp;Delete User - Are you sure?</p>
                            </div>
                        ...
                        {isFetching
                            ...
                            <>
                                ...
                                {user && <div className="container">
                                    <p>You are about to <b>permanently delete</b> this user; it will no longer exist in our database. This action can be undone but you'll need to contact the system administrator. Are you sure you would like to continue?</p>
                                    ...
                                    <div className="columns pt-5">
                                        ...
                                        <div className="column is-half has-text-right">
                                            <button className="button is-danger is-fullwidth-mobile" onClick={onSubmitClick}><FontAwesomeIcon className="fas" icon={faCheckCircle} type="button" />&nbsp;Confirm and Delete</button>
                                        </div>
                                    </div>
