                ...
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li className="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faBoxOpen} />&nbsp;Unarchive</Link></li>
                        </ul>
                    </nav>
                    ...
                    <nav className="box">
                        ...
                        {user && <div className="columns">
                            <div className="column">
                                <p className="title is-4"><FontAwesomeIcon className="fas" icon={faBoxOpen} />&nbsp;Unarchive User - Are you sure?</p>
                            </div>
                        ...
                        {isFetching
                            ...
                            <>
                                ...
                                {user && <div className="container">
                                    <p>You are about to <b>unarchive</b> this user; this user will exist in list. Are you sure you would like to continue?</p>
                                    ...
                                    <div className="columns pt-5">
                                        ...
                                        <div className="column is-half has-text-right">
                                            <button className="button is-danger is-fullwidth-mobile" onClick={onSubmitClick}><FontAwesomeIcon className="fas" icon={faCheckCircle} type="button" />&nbsp;Confirm and Unarchive</button>
                                        </div>
                                    </div>
