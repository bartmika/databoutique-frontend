...
import { DEFAULT_USER_LIST_SORT_BY_VALUE, DEFAULT_USER_STATUS_FILTER_OPTION,  RESIDENTIAL_USER_TYPE_OF_ID, COMMERCIAL_USER_TYPE_OF_ID } from "../../../../Constants/App";
...
function AdminUserAddStep1PartB() {
    ////
    //// URL Parameters.
    ////
    ...
    const onAddUserClick = (e) => {
        console.log("deleting previous addUser:", addUser);
        setAddUser(ADD_USER_STATE_DEFAULT);
        setForceURL("/admin/users/add/step-2");
    }
    ////
    //// Misc.
    ////
            ...
            <div className="container">
                <section className="section">
                    ...
                    <nav className="box has-background-light" >
                        ...
                        <progress class="progress is-success" value="17" max="100">17%</progress>
                    </nav>
                            ...
                            <>
                                                        ...
                                                        <header className="card-header">
                                                            <p className="card-header-title">
                                                                <Link to={`/admin/user/${datum.id}`}>
                                                                    {datum.type === COMMERCIAL_USER_TYPE_OF_ID &&
                                                                        <strong>
                                                                            <FontAwesomeIcon className="fas" icon={faBuilding} />&nbsp;{datum.organizationName}
                                                                        </strong>
                                                                    }
                                                                    {datum.type === RESIDENTIAL_USER_TYPE_OF_ID &&
                                                                        <strong>
                                ...
                                <div className="columns pt-5">
                                    <div className="column has-text-centered">
                                        <Link className="button is-medium is-fullwidth-mobile" to="/admin/users/add/step-1-search"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Search Again</Link>&nbsp;
                                        <Link className="button is-medium is-success is-fullwidth-mobile" onClick={onAddUserClick}><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;Add user</Link>
                                    </div>
                                </div>
                            </>
                        }
...
export default AdminUserAddStep1PartB;
