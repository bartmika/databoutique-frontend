...
function AdminUserAddStep1PartA() {
    ////
    //// Global state.
    ////
    ...
    const onSubmitClick = (e) => {
        ...
        setForceURL("/admin/users/add/step-1-results?fn="+firstName+"&ln="+lastName+"&e="+email+"&p="+phone);
    }
                        ...
                        <div className={`modal ${showCancelWarning ? 'is-active' : ''}`}>
                            ...
                            <div className="modal-card">
                                ...
                                <footer className="modal-card-foot">
                                    <Link className="button is-medium is-success" to={`/admin/users`}>Yes</Link>
...
export default AdminUserAddStep1PartA;
