...
import { addUserState, ADD_CUSTOMER_STATE_DEFAULT, topAlertMessageState, topAlertStatusState } from "../../../AppState";
import {
    USER_PHONE_TYPE_OF_OPTIONS_WITH_EMPTY_OPTIONS, USER_TYPE_OF_FILTER_OPTIONS,
    USER_ORGANIZATION_TYPE_OPTIONS,
    USER_ORGANIZATION_TYPE_OPTIONS_WITH_EMPTY_OPTIONS,
...
function AdminUserUpdate() {
    ...
    const onSubmitClick = (e) => {
        ...
        setFetching(true);
        setErrors({});
        putUserUpdateAPI(data, onSuccess, onError, onDone, onUnauthorized);
    }
    ...
    function onSuccess(response){
        ...
        setTopAlertMessage("User update");
                ...
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li className=""><Link to={`/admin/user/${cid}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faEye} />&nbsp;Detail</Link></li>
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li className=""><Link to={`/admin/user/${cid}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Detail</Link></li>
                        </ul>
                    </nav>
                            ...
                            <>
                                ...
                                {user && <div className="columns">
                                    <div className="column">
                                        <p className="title is-4"><FontAwesomeIcon className="fas" icon={faPencil} />&nbsp;Edit User</p>
                                ...
                                {user && <div className="container" key={`user_${user.id}_modified_at_${user.modifiedAt}`}>

                                    <p className="title is-5"><FontAwesomeIcon className="fas" icon={faCogs} />&nbsp;Settings</p>
                                    ...
                                    <p className="title is-5"><FontAwesomeIcon className="fas" icon={faIdCard} />&nbsp;Contact</p>

                                    {userType === COMMERCIAL_CUSTOMER_TYPE_OF_ID && <>
                                        <FormInputField
                                    ...
                                    <p className="title is-5"><FontAwesomeIcon className="fas" icon={faAddressBook} />&nbsp;Address</p>
                                    ...
                                    <p className="title is-5"><FontAwesomeIcon className="fas" icon={faChartPie} />&nbsp;Metrics</p>
                                    ...
                                    <div className="columns pt-5">
                                        <div className="column is-half">
                                            <Link className="button is-fullwidth-mobile" to={`/admin/user/${cid}`}><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Detail</Link>
                                        </div>
                                        <div className="column is-half has-text-right">
                                            <button onClick={onSubmitClick} className="button is-success is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faCheckCircle} type="button" />&nbsp;Save</button>
                                        </div>
                                    </div>
