...
function AdminAssistantFileUpdate() {
    ////
    //// URL Parameters.
    ////
    ...
    const onSubmitClick = (e) => {
        ...
        putAssistantFileUpdateAPI(
            id,
            formData,
            onAdminAssistantFileUpdateSuccess,
            onAdminAssistantFileUpdateError,
            onAdminAssistantFileUpdateDone,
            onUnauthorized
        );
    ...
    function onAdminAssistantFileUpdateSuccess(response){
        // For debugging purposes only.
        console.log("onAdminAssistantFileUpdateSuccess: Starting...");
        ...
        setTimeout(() => {
            console.log("onAdminAssistantFileUpdateSuccess: Delayed for 2 seconds.");
            console.log("onAdminAssistantFileUpdateSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onAdminAssistantFileUpdateError(apiErr) {
        console.log("onAdminAssistantFileUpdateError: Starting...");
        setErrors(apiErr);
        ...
        setTimeout(() => {
            console.log("onAdminAssistantFileUpdateError: Delayed for 2 seconds.");
            console.log("onAdminAssistantFileUpdateError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onAdminAssistantFileUpdateDone() {
        console.log("onAdminAssistantFileUpdateDone: Starting...");
        setFetching(false);
    }
...
export default AdminAssistantFileUpdate;
