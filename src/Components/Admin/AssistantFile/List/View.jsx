...
import AdminAssistantFileListDesktop from "./Desktop";
import AdminAssistantFileListMobile from "./Mobile";


function AdminAssistantFileList() {
...
export default AdminAssistantFileList;
