...
function CustomerAssistantThreadDetail() {
    ////
    //// URL Parameters.
    ////
                                    ...
                                    {assistant.status === ASSISTANT_THREAD_STATUS_ACTIVE && <>
                                        {listData && listData.results && <>
                                            {listData.results.map(function(message, i){
                                                ...
                                                const fromWhom = message.fromAssistant ? "Assistant" : "You";
                                    ...
                                    <div className="columns pt-5">
                                        <div className="column is-half">
                                            <Link to={`/assistant-threads`} className="button is-fullwidth-mobile">
                                                <FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Assistant threads
                                            </Link>
                                        </div>
...
export default CustomerAssistantThreadDetail;
