...
import { putAssistantUpdateAPI, getAssistantDetailAPI } from "../../../../API/Assistant";
...
function CustomerAssistantUpdate() {
    ////
    //// URL Parameters.
    ////
    ...
    const onSubmitClick = (e) => {
        ...
        putAssistantUpdateAPI(
            decamelizedData,
            onCustomerAssistantUpdateSuccess,
            onCustomerAssistantUpdateError,
            onCustomerAssistantUpdateDone,
            onUnauthorized
        );
    ...
    function onCustomerAssistantUpdateSuccess(response){
        // For debugging purposes only.
        console.log("onCustomerAssistantUpdateSuccess: Starting...");
        console.log(response);

        // Add a temporary banner message in the app and then clear itself after 2 seconds.
        setTopAlertMessage("Assistant updated");
        setTopAlertStatus("success");
        setTimeout(() => {
            console.log("onCustomerAssistantUpdateSuccess: Delayed for 2 seconds.");
            console.log("onCustomerAssistantUpdateSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onCustomerAssistantUpdateError(apiErr) {
        console.log("onCustomerAssistantUpdateError: Starting...");
        setErrors(apiErr);
        ...
        setTimeout(() => {
            console.log("onCustomerAssistantUpdateError: Delayed for 2 seconds.");
            console.log("onCustomerAssistantUpdateError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onCustomerAssistantUpdateDone() {
        console.log("onCustomerAssistantUpdateDone: Starting...");
        setFetching(false);
    }
    ...
    function onSuccess(response){
        ...
        try {
            ...
            if (response.assistantFiles) {
                ...
                setAssistantFiles(assistantFileIDs);
            }
        } catch (e) {
            // Do nothing.
        }
                ...
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li className=""><Link to="/admin/assistants" aria-current="page"><FontAwesomeIcon className="fas" icon={faCodeBranch} />&nbsp;Assistant</Link></li>
                    ...
                    {/* Page Title */}
                    <h1 className="title is-2"><FontAwesomeIcon className="fas" icon={faCodeBranch} />&nbsp;Assistant</h1>
...
export default CustomerAssistantUpdate;
