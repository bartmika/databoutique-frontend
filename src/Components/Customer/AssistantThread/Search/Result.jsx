...
import CustomerAssistantSearchResultDesktop from "../List/Desktop";
import CustomerAssistantSearchResultMobile from "../List/Mobile";


function CustomerAssistantSearchResult() {
    ////
    //// URL Parameters.
    ////
                    ...
                    <nav className="box" style={{ borderRadius: "20px"}}>
                        ...
                        */}
                                ...
                                {listData && listData.results && (listData.results.length > 0 || previousCursors.length > 0)
                                    ...
                                    <div className="container">
                                        ...
                                        */}
                                        <div className="is-hidden-touch" >
                                            <CustomerAssistantSearchResultDesktop
                                                listData={listData}
                                                listCount={listCount}
                                        ...
                                        */}
                                        <div className="is-fullwidth is-hidden-desktop">
                                            <CustomerAssistantSearchResultMobile
                                                listData={listData}
                                                listCount={listCount}
                                                setPageSize={setPageSize}
                                                pageSize={pageSize}
                                    ...
                                    <section className="hero is-medium has-background-white-ter">
                                        <div className="hero-body">
                                            <p className="title">
                                                <FontAwesomeIcon className="fas" icon={faTable} />&nbsp;No Assistant
                                            </p>
                                            <p className="subtitle">
                                                No assistant. <b><Link to="/admin/assistants/search">Click here&nbsp;<FontAwesomeIcon className="mdi" icon={faArrowRight} /></Link></b> to get try another search query.
                                            </p>
                                        </div>
                                    </section>
                                }
                        ...
                        <div className="columns pt-5">
                            <div className="column is-half">
                                <Link className="button is-medium is-fullwidth-mobile" to="/admin/assistants/search"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Search Again</Link>&nbsp;
                            </div>
                            <div className="column is-half has-text-right">
...
export default CustomerAssistantSearchResult;
