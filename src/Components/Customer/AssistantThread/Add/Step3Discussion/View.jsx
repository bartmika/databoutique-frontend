...
import { getAssistantDetailAPI } from "../../../../../API/Assistant";
import { postAssistantThreadCreateAPI } from "../../../../../API/AssistantThread";
...
function CustomerAssistantThreadAddStep3Discussion() {
    ////
    //// Global state.
    ////
    ...
    function onAddSuccess(response){
        ...
        setTopAlertMessage("Assistant thread created");
    ...
    useEffect(() => {
        ...
        if (mounted) {
            ...
            getAssistantDetailAPI(
                addAssistantThread.assistantID,
                onSuccess,
                onError,
                onDone,
                onUnauthorized
        ...
        <>
            <div className="container">
                <section className="section">
                    ...
                    {/* Page */}
                    <nav className="box">
                        <p className="title is-4"><FontAwesomeIcon className="fas" icon={faUserGear} />&nbsp;Assistant Thread</p>
                        <>
...
export default CustomerAssistantThreadAddStep3Discussion;
