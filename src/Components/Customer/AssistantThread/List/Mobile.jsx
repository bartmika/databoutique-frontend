...
*/
function CustomerClientListMobile(props) {
        ...
        <>
            {listData && listData.results && listData.results.map(function(datum, i){
                return <div className="mb-5">
                    <hr />
                    <strong>Assistant Name:</strong>&nbsp;{datum.assistantName}
                    <br />
                    <br />
                    <Link to={`/assistant-thread/${datum.id}`} className="button is-primary is-fullwidth-mobile" type="button">
...
export default CustomerClientListMobile;
