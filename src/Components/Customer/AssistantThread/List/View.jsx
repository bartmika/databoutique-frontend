...
import { getAssistantThreadListAPI, deleteAssistantThreadAPI } from "../../../../API/AssistantThread";
import {
...
import CustomerAssistantListDesktop from "./Desktop";
import CustomerAssistantListMobile from "./Mobile";


function CustomerAssistantList() {
                ...
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-touch" aria-label="breadcrumbs">
                        <ul className="">
                            ...
                            <li className="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faCodeBranch} />&nbsp;Assistant Threads</Link></li>
                        </ul>
                    </nav>
                                ...
                                <div className="columns is-vcentered">
                                    <div className="column">
                                        <BubbleLink
                                            ...
                                            faIcon={faPlus}
                                            url={`/assistant-threads/add/step-1`}
                                ...
                                {listData && listData.results && (listData.results.length > 0 || previousCursors.length > 0)
                                    ...
                                    <section className="hero is-medium has-background-white-ter">
                                        <div className="hero-body">
                                            <p className="title">
                                                <FontAwesomeIcon className="fas" icon={faTable} />&nbsp;No Assistant Threads
                                            </p>
                                            <p className="subtitle">
                                                No assistant threads. <b><Link to="/assistant-threads/add/step-1">Click here&nbsp;<FontAwesomeIcon className="mdi" icon={faArrowRight} /></Link></b> to get started creating your first thread.
                                            </p>
                                        </div>
                                    </section>
                                }
...
export default CustomerAssistantList;
