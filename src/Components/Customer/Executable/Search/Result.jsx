...
import CustomerExecutableSearchResultDesktop from "../List/Desktop";
import CustomerExecutableSearchResultMobile from "../List/Mobile";


function CustomerExecutableSearchResult() {
    ////
    //// URL Parameters.
    ////
                                ...
                                {listData && listData.results && (listData.results.length > 0 || previousCursors.length > 0)
                                    ...
                                    <div className="container">
                                        ...
                                        */}
                                        <div className="is-hidden-touch" >
                                            <CustomerExecutableSearchResultDesktop
                                                listData={listData}
                                                listCount={listCount}
                                        ...
                                        */}
                                        <div className="is-fullwidth is-hidden-desktop">
                                            <CustomerExecutableSearchResultMobile
                                                listData={listData}
                                                listCount={listCount}
                                                setPageSize={setPageSize}
                                                pageSize={pageSize}
                                    ...
                                    <section className="hero is-medium has-background-white-ter">
                                        <div className="hero-body">
                                            <p className="title">
                                                <FontAwesomeIcon className="fas" icon={faTable} />&nbsp;No Executable
                                            </p>
...
export default CustomerExecutableSearchResult;
