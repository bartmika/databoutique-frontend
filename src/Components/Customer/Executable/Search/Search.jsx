...
function CustomerExecutableSearch() {
    ////
    //// Global state.
    ////
            ...
            <div className="container">
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li className=""><Link to="/admin/clients" aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Executable</Link></li>
                        </ul>
                    </nav>
                                ...
                                <div className="container">
                                    ...
                                    <div className="columns pt-5">
                                        <div className="column is-half">
                                            <Link className="button is-medium is-fullwidth-mobile" to="/admin/assistants"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Executable</Link>
                                        </div>
...
export default CustomerExecutableSearch;
