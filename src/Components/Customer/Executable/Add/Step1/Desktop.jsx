...
function CustomerExecutableAddStep1Desktop(props) {
    const { listData, listCount, setPageSize, pageSize, previousCursors, onPreviousClicked, onNextClicked, sortByValue, onPick } = props;
    return (
                    ...
                    <tbody>
                        {listData && listData.results && listData.results.map(function(datum, i){
                            return <tr>
                                ...
                                <td data-label="Description">{datum.description}</td>
                                <td data-label="Created At">{datum.createdAt}</td>
                                <td className="is-actions-cell">
                                    <div className="buttons is-right">
                                        <Link onClick={(e)=>onPick(datum.id)} className="is-small">
...
export default CustomerExecutableAddStep1Desktop;
