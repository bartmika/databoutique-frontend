...
import CustomerExecutableAddStep1Desktop from "./Desktop";
import CustomerExecutableAddStep1Mobile from "./Mobile";


function CustomerExecutableAddStep1() {
            ...
            <div className="container">
                <section className="section">
                    ...
                    <nav className="box has-background-light" >
                        <p className="subtitle is-5">Step 1 of 2</p>
                                    ...
                                    <div className="container">
                                        ...
                                        */}
                                        <div className="is-hidden-touch" >
                                            <CustomerExecutableAddStep1Desktop
                                                listData={listData}
                                                listCount={listCount}
                                        ...
                                        */}
                                        <div className="is-fullwidth is-hidden-desktop">
                                            <CustomerExecutableAddStep1Mobile
                                                listData={listData}
                                                listCount={listCount}
                                                setPageSize={setPageSize}
                                                pageSize={pageSize}
...
export default CustomerExecutableAddStep1;
