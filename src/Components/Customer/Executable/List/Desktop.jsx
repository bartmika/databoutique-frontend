...
function CustomerExecutableListDesktop(props) {
                ...
                <table className="table is-fullwidth is-striped is-hoverable is-fullwidth">
                    <thead>
                        <tr>
                            ...
                            <th>
                                Last Modified At
                                {sortByValue === "modified_at,ASC" && <>&nbsp;<FontAwesomeIcon className="fas" icon={faCaretUp} /></>}
                                {sortByValue === "modified_at,DESC" && <>&nbsp;<FontAwesomeIcon className="fas" icon={faCaretDown} /></>}
                            </th>
                            <th></th>
                        </tr>
                    </thead>
                            ...
                            return <tr>
                                ...
                                <td className="is-actions-cell">
                                    <div className="buttons is-right">
                                        <Link to={`/executable/${datum.id}`} className="is-small">
...
export default CustomerExecutableListDesktop;
