...
function CustomerAssistantFileAdd() {
    ////
    //// Global state.
    ////
    ...
    const onSubmitClick = (e) => {
        ...
        postAssistantFileCreateAPI(
            formData,
            onCustomerUserAssistantFileAddSuccess,
            onCustomerUserAssistantFileAddError,
            onCustomerUserAssistantFileAddDone,
            onUnauthorized
        );
    ...
    function onCustomerUserAssistantFileAddSuccess(response){
        // For debugging purposes only.
        console.log("onCustomerUserAssistantFileAddSuccess: Starting...");
        ...
        setTimeout(() => {
            console.log("onCustomerUserAssistantFileAddSuccess: Delayed for 2 seconds.");
            console.log("onCustomerUserAssistantFileAddSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onCustomerUserAssistantFileAddError(apiErr) {
        console.log("onCustomerUserAssistantFileAddError: Starting...");
        setErrors(apiErr);
        ...
        setTimeout(() => {
            console.log("onCustomerUserAssistantFileAddError: Delayed for 2 seconds.");
            console.log("onCustomerUserAssistantFileAddError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onCustomerUserAssistantFileAddDone() {
        console.log("onCustomerUserAssistantFileAddDone: Starting...");
        setFetching(false);
    }
...
export default CustomerAssistantFileAdd;
