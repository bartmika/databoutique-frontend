...
import CustomerAssistantFileListDesktop from "./Desktop";
import CustomerAssistantFileListMobile from "./Mobile";


function CustomerAssistantFileList() {
                ...
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-touch" aria-label="breadcrumbs">
                        <ul className="">
                            ...
                            <li className="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faFile} />&nbsp;Assistant Files</Link></li>
                        </ul>
                    </nav>
                            ...
                            <div className="container">
                                <div className="columns is-vcentered">
                                    <div className="column">
                                        <BubbleLink
                                            title={`Add`}
                                            subtitle={`Add assistant files`}
                                            faIcon={faPlus}
                                            url={`/admin/assistant-files/add`}
                                    ...
                                    <div className="column">
                                        <BubbleLink
                                            title={`Search`}
                                            subtitle={`Search assistant files`}
                                            faIcon={faSearch}
                                            url={`/admin/assistant-files/search`}
                                ...
                                {listData && listData.results && (listData.results.length > 0 || previousCursors.length > 0)
                                    ...
                                    <div className="container">
                                        ...
                                        */}
                                        <div className="is-hidden-touch" >
                                            <CustomerAssistantFileListDesktop
                                                listData={listData}
                                                listCount={listCount}
                                        ...
                                        */}
                                        <div className="is-fullwidth is-hidden-desktop">
                                            <CustomerAssistantFileListMobile
                                                listData={listData}
                                                listCount={listCount}
                                                setPageSize={setPageSize}
                                                pageSize={pageSize}
                                    ...
                                    <section className="hero is-medium has-background-white-ter">
                                        <div className="hero-body">
                                            <p className="title">
                                                <FontAwesomeIcon className="fas" icon={faTable} />&nbsp;No AssistantFiles
                                            </p>
                                            <p className="subtitle">
                                                No assistant files. <b><Link to="/admin/assistant-files/add">Click here&nbsp;<FontAwesomeIcon className="mdi" icon={faArrowRight} /></Link></b> to get started creating your first assistant file.
                                            </p>
                                        </div>
                                    </section>
                                }
...
export default CustomerAssistantFileList;
