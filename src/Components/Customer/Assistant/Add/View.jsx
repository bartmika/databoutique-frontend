...
function CustomerAssistantAdd() {
    ...
    const onSubmitClick = (e) => {
        ...
        postAssistantCreateAPI(
            decamelizedData,
            onCustomerUserAssistantAddSuccess,
            onCustomerUserAssistantAddError,
            onCustomerUserAssistantAddDone,
            onUnauthorized
        );
    ...
    function onCustomerUserAssistantAddSuccess(response){
        // For debugging purposes only.
        console.log("onCustomerUserAssistantAddSuccess: Starting...");
        ...
        setTimeout(() => {
            console.log("onCustomerUserAssistantAddSuccess: Delayed for 2 seconds.");
            console.log("onCustomerUserAssistantAddSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onCustomerUserAssistantAddError(apiErr) {
        console.log("onCustomerUserAssistantAddError: Starting...");
        setErrors(apiErr);
        ...
        setTimeout(() => {
            console.log("onCustomerUserAssistantAddError: Delayed for 2 seconds.");
            console.log("onCustomerUserAssistantAddError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onCustomerUserAssistantAddDone() {
        console.log("onCustomerUserAssistantAddDone: Starting...");
        setFetching(false);
    }
            ...
            <div className="container">
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li className=""><Link to={`/admin/assistants`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Detail (Assistants)</Link></li>
                        </ul>
                    </nav>
...
export default CustomerAssistantAdd;
