...
import CustomerUploadDirectorySearchResultDesktop from "../List/Desktop";
import CustomerUploadDirectorySearchResultMobile from "../List/Mobile";


function CustomerUploadDirectorySearchResult() {
    ////
    //// URL Parameters.
    ////
                                    ...
                                    <div className="container">
                                        ...
                                        */}
                                        <div className="is-hidden-touch" >
                                            <CustomerUploadDirectorySearchResultDesktop
                                                listData={listData}
                                                listCount={listCount}
                                        ...
                                        */}
                                        <div className="is-fullwidth is-hidden-desktop">
                                            <CustomerUploadDirectorySearchResultMobile
                                                listData={listData}
                                                listCount={listCount}
                                                setPageSize={setPageSize}
                                                pageSize={pageSize}
...
export default CustomerUploadDirectorySearchResult;
