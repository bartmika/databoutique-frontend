...
import CustomerUploadFileSearchResultDesktop from "../List/Desktop";
import CustomerUploadFileSearchResultMobile from "../List/Mobile";


function CustomerUploadFileSearchResult() {
    ////
    //// URL Parameters.
    ////
                    ...
                    <nav className="box" style={{ borderRadius: "20px"}}>
                        ...
                        */}
                                    ...
                                    <div className="container">
                                        ...
                                        */}
                                        <div className="is-hidden-touch" >
                                            <CustomerUploadFileSearchResultDesktop
                                                listData={listData}
                                                listCount={listCount}
                                        ...
                                        */}
                                        <div className="is-fullwidth is-hidden-desktop">
                                            <CustomerUploadFileSearchResultMobile
                                                listData={listData}
                                                listCount={listCount}
                                                setPageSize={setPageSize}
                                                pageSize={pageSize}
                                    ...
                                    <section className="hero is-medium has-background-white-ter">
                                        <div className="hero-body">
                                            ...
                                            <p className="subtitle">
                                                No assistant files. <b><Link to="/assistant-files/search">Click here&nbsp;<FontAwesomeIcon className="mdi" icon={faArrowRight} /></Link></b> to get try another search query.
                                            </p>
                                        </div>
                                    </section>
                                }
                        ...
                        <div className="columns pt-5">
                            <div className="column is-half">
                                <Link className="button is-medium is-fullwidth-mobile" to="/assistant-files/search"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Search Again</Link>&nbsp;
                            </div>
                            <div className="column is-half has-text-right">
...
export default CustomerUploadFileSearchResult;
