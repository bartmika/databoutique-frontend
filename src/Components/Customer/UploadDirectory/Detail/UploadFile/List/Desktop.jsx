...
function CustomerUploadDirectoryUploadFileListDesktop(props) {
                            ...
                            return <tr>
                                ...
                                <td className="is-actions-cell">
                                    <div className="buttons is-right">
                                        <Link to={`/upload-directory/${udid}/upload-file/${datum.id}`} className="is-small">
...
export default CustomerUploadDirectoryUploadFileListDesktop;
