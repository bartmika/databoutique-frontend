                ...
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-touch" aria-label="breadcrumbs">
                        <ul className="">
                            ...
                            <li className=""><Link to="/upload-directories" aria-current="page"><FontAwesomeIcon className="fas" icon={faCloudUpload} />&nbsp;My Uploads</Link></li>
                    ...
                    <nav className="box" style={{ borderRadius: "20px"}}>
                        ...
                        <div className="columns pt-5">
                            <div className="column is-half">
                                <Link className="button is-fullwidth-mobile" to={`/upload-directories`}><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to My Uploads</Link>
                            </div>
                            <div className="column is-half has-text-right">
