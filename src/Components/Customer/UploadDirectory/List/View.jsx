...
import CustomerUploadDirectoryListDesktop from "./Desktop";
import CustomerUploadDirectoryListMobile from "./Mobile";


function CustomerUploadDirectoryList() {
                                    ...
                                    <div className="container">
                                        ...
                                        */}
                                        <div className="is-hidden-touch" >
                                            <CustomerUploadDirectoryListDesktop
                                                listData={listData}
                                                listCount={listCount}
                                        ...
                                        */}
                                        <div className="is-fullwidth is-hidden-desktop">
                                            <CustomerUploadDirectoryListMobile
                                                listData={listData}
                                                listCount={listCount}
                                                setPageSize={setPageSize}
                                                pageSize={pageSize}
...
export default CustomerUploadDirectoryList;
