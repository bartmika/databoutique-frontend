                                    ...
                                    <div className="column is-half-tablet">
                                        <div className="box is-rounded">
                                            ...
                                            <nav className="level">
                                                <div className="level-item has-text-centered">
                                                    <div>
                                                        <a href="https://github.com/bartmika/databoutique-backend" className="is-size-7-tablet"><FontAwesomeIcon icon={faArrowLeft} /> Back Home</a>
                                                    </div>
                                                </div>
                                                <div className="level-item has-text-centered">
                                                    {/*
                                                    <div>
                                                        <Link to="/cpsrn-registry" className="is-size-7-tablet">DATABOUTIQUERN Registry <FontAwesomeIcon icon={faArrowRight} /></Link>
                                                    </div>
                                                    */}
                                                </div>
                                            </nav>
