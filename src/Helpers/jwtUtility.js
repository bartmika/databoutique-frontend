...
import { DATABOUTIQUE_LOGIN_API_ENDPOINT, DATABOUTIQUE_REFRESH_TOKEN_API_URL } from "../Constants/API";
...
export function setAccessTokenInLocalStorage(accessToken) {
    if (accessToken !== undefined && accessToken !== null) {
        localStorage.setItem("DATABOUTIQUE_TOKEN_UTILITY_ACCESS_TOKEN_DATA", accessToken);
    } else {
...
export function setRefreshTokenInLocalStorage(accessToken) {
    if (accessToken !== undefined && accessToken !== null)  {
        localStorage.setItem("DATABOUTIQUE_TOKEN_UTILITY_REFRESH_TOKEN_DATA", accessToken);
    } else {
...
export function getAccessTokenFromLocalStorage() {
    return localStorage.getItem("DATABOUTIQUE_TOKEN_UTILITY_ACCESS_TOKEN_DATA");
}
...
export function getRefreshTokenFromLocalStorage() {
    return localStorage.getItem("DATABOUTIQUE_TOKEN_UTILITY_REFRESH_TOKEN_DATA");
}
...
export function clearAllAccessAndRefreshTokensFromLocalStorage() {
    localStorage.removeItem("DATABOUTIQUE_TOKEN_UTILITY_ACCESS_TOKEN_DATA");
    localStorage.removeItem("DATABOUTIQUE_TOKEN_UTILITY_REFRESH_TOKEN_DATA");
}
...
function atteptLogin(email, password) {
    return axios.post(DATABOUTIQUE_LOGIN_API_ENDPOINT, {
        'email': email,
        'password': password,
    })
}
...
function atteptRefresh(refreshTokenString) {
    return axios.post(DATABOUTIQUE_REFRESH_TOKEN_API_URL, {
